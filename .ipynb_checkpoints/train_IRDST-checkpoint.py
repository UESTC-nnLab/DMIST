...
if __name__ == "__main__":
    ...
    # train_annotation_path = '/home/public/DMIST/DMIST_train.txt'
    # val_annotation_path = '/home/public/DMIST/DMIST_60_val.txt' #DMIST_100_val.txt
    ...
    model = LASNet(num_classes=1,  dataset='IRDST', num_frame=5) 
    weights_init(model)
    if model_path != '':
