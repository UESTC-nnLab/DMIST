...
map_mode            = 0
dataset             = 'DMIST' 
cocoGt_path         = '/home/public/IRDST/annotations/instances_test2017.json' #100_coco_val.json
...
class MAP_vid(object):
    _defaults = {
        ...
        "model_path"        : '/home/chenshengjia/work4/YOLOX/logs/loss_2024_02_03_15_17_48/ep019-loss4.394-val_loss3.658.pth',
    ...
    def generate(self, onnx=False):
        ...
        self.net    = LASNet(self.num_classes, self.dataset, num_frame=5)
